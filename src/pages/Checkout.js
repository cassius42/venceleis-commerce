...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    setFormData((prevState) => ({
      ...
      userId: user && user.user ? user.user.id : null,
    }));
  }, []);
        ...
        <div className="h-[400px]">
          ...
          <div className="mb-4">
            ...
            >
              ...
              <option value="BCA" className="text-sm w-10">
                BCA
              </option>
              <option value="Mandiri" className="text-sm w-10">
                Mandiri
              </option>
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center">
              ...
              <div className="w-full mb-8 flex border-b pb-4">
                ...
                <div className="ml-5">
                  <p className="font-bold text-xl">Order Info</p>
                  <p>Shipping: {formData.country}</p>
                  <p>Pay Method: {formData.payment}</p>
                </div>
              </div>
